...
export default function PreprocessListPage() {
    ...
    useEffect(() => {
        ...
        if (storedData) {
            ...
            // This ensures backward compatibility for older data structures.
                                ...
                                <tr key={item.id} className="border-b hover:bg-green-50">
                                    ...
                                    <td className="p-2 border">
                                        <div className="flex flex-wrap items-center gap-2">
                                            <button onClick={() => router.push(`/crm/pipelines/preprocess/${item.id}/view`)} className="px-3 py-1 text-xs text-white bg-blue-500 rounded-md hover:bg-blue-600">View</button>
                                            <button onClick={() => router.push(`/crm/pipelines/preprocess/${item.id}/edit`)} className="px-3 py-1 text-xs text-white bg-yellow-500 rounded-md hover:bg-yellow-600">Edit</button>
